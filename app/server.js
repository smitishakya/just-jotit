...
// https://expressjs.com/
const express = require('express');//writing router
// To learn more about the morgan NPM module, see official NPM docs
// https://www.npmjs.com/package/morgan 
const morgan = require('morgan');//log express request
...
// MIDDLEWARE - every request you make to the server its first going through these middlware 
...
//If you make a request to your URL that you don't have a request listener or handler
//it just responds with a status code that not found 
...
function startServer(testEnv) {
    ...
    return new Promise((resolve, reject) => {
        let mongoUrl;
        //testEnv - pass true test db will run n else it coz u don't want wipe ur db (test wipes ur db when it runs)
        //db out else then actual db runs 
        if (testEnv) {
