...
describe('Integration tests for: /api/auth', function () {
    ...
    beforeEach(function () {
        //create new fake user object we manually store mongo db user
        ...
        return User.hashPassword(testUser.password).then(hashedPassword => {
            ...
            })//extract user id saved into created test user
                .then(createdUser => {
    ...
    it('Should login correctly and return a valid JSON Web Token', function () {
        return chai.request(app)
            ...
            .then(res => {
                expect(res).have.status(HTTP_STATUS_CODES.OK);
    ...
    it('Should refresh the user JSON Web Token', function () {
        ...
        return chai.request(app)
            ...
            .then(res => {
                ...
                //new JWT token news to have expire date allows to verify after old
